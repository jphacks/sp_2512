...
export default function SafetyPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <header className="sticky top-0 z-10 bg-gradient-to-r from-red-500 via-red-600 to-orange-500 shadow-lg">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h1 className="text-2xl font-black text-white tracking-tight">治安・事件情報</h1>
            ...
            <Button
              ...
              className="bg-white text-red-600 hover:bg-white/90 font-semibold shadow-md transition-all hover:scale-105"
            >
